...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
        ...
        MatcherAssert.assertThat(sortedAgeList, contains(21, 22, 22, 26, 27, 28, 32, 35, 36, 38));
    }
    ...
    public void descSortByAge() {
        ...
        List<Integer> sortedAgeList = sortedAgeStream.collect(Collectors.toList());
        MatcherAssert.assertThat(sortedAgeList, contains(38, 36, 35, 32, 28, 27, 26, 22, 22, 21));
    }
    ...
    public void top3RichCustomer() {
        ...
        Stream<String> top3RichCustomerStream = customerList.stream()
            .sorted((a, b) -> b.getBudget().compareTo(a.getBudget()))
            .map(Customer::getName)
            .limit(3);

        List<String> top3RichCustomerList = top3RichCustomerStream.collect(Collectors.toList());
        MatcherAssert.assertThat(top3RichCustomerList, contains("Diana", "Andrew", "Chris"));
    }
    ...
    public void distinctAge() {
        ...
        MatcherAssert.assertThat(distinctAgeList, contains(22, 27, 28, 38, 26, 32, 35, 21, 36));
    }
    ...
    public void itemsCustomersWantToBuy() {
        ...
        MatcherAssert.assertThat(itemList,
